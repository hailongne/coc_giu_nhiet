                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="product-large-slider">
                                    ...
                                    <?php if($anhSanPham ['link_hinh_anh']) {?>
                            ...
                            <div class="col-lg-7">
                                <div class="product-details-des">
                                    ...
                                    <div class="availability">
                                        ...
                                        <span>Số Lượng: <strong><?= $sanPham['so_luong'] ?></strong> Sản Phẩm</span>
                                    </div>
                                        ...
                                        <div class="tab-pane fade show active" id="tab_three">
                                            ...
                                            <div class="total-reviews">
                                                <div class="rev-avatar">
                                                    <img src="<?= $binhLuan['anh_dai_dien']?>"
                                                        onerror=" this.onerror=null;
                                                    this.src='https://i.pinimg.com/originals/fc/04/73/fc047347b17f7df7ff288d78c8c281cf.png'">
                                                </div>
                                                <div class=" review-box">
                                                    <div class="post-author">
                                                        <p><span><strong><?= $binhLuan['ho_ten']?></strong>
                                                            </span><?= date('d-m-Y', strtotime($binhLuan['ngay_dang'])) ?>
                                                        </p>
                                                    </div>
                                            ...
                                            <form action="#" class="review-form">
                                                ...
                                                <div class="buttons">
                                                    <button class="btn btn-sqr" type="submit">Send <i
            ...
            <div class="row">
                <div class="col-12">
                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                        <?php foreach ($listSanPhamFromDanhMuc as $key => $sanPham) : ?>
                        <!-- product item start -->
